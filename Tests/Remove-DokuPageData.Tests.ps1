Describe 'Remove-DokuPageData' {
    ...
    Context 'When the Invoke-DokuApiCall command fails' {
        It 'Should display the exception message' {
            ...
            Remove-DokuPageData -FullName 'rootns:ns:pagename' -RawWikiText 'Test Data' -MinorChange -SummaryText 'Summary' -Confirm:$False -PassThru -ErrorAction SilentlyContinue -ErrorVariable DokuErrorVariable
    ...
    Context 'When the page data is removed successfully' {
        InModuleScope PSDokuWiki {
            ...
            It 'Should not throw' {
                { Remove-DokuPageData -FullName 'rootns:ns:pagename' -MinorChange -SummaryText 'Summary' -Confirm:$False } | Should -Not -Throw
            }
            It 'Should not return anything' {
                Remove-DokuPageData -FullName 'rootns:ns:pagename'  -SummaryText 'Summary' -Confirm:$False | Should -BeNullOrEmpty
            }
        }
    }
    Context 'When page data is removed for two pages' {
        InModuleScope PSDokuWiki {
            ...
            It 'Should call Invoke-DokuApiCall twice' {
                Remove-DokuPageData -FullName 'rootns:ns:pagename', 'rootns2:ns2:pagename2' -SummaryText 'Summary' -Confirm:$False
