Describe 'Add-DokuPageData' {
    ...
    Context 'When the Invoke-DokuApiCall command fails' {
        ...
        It 'Should display the fault code & string' {
            ...
            Add-DokuPageData -FullName "namespace:pagename" -RawWikiText "RawWikiText" -ErrorAction SilentlyContinue -ErrorVariable DokuErrorVariable
    ...
    Context 'When PassThru is used' {
        InModuleScope PSDokuWiki {
            ...
            $ResponseObject = Add-DokuPageData -FullName "rootns:ns:pagename" -RawWikiText "Hello world!" -MinorChange -SummaryText "Summary" -PassThru
            ...
            It 'Should return an object with the correct value for AddedText' {
                $ResponseObject.AddedText | Should -Be 'Hello world!'
            }
