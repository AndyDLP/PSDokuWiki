Describe 'Get-DokuPageInfo' {
    ...
    Context 'When the Invoke-DokuApiCall command fails' {
        It 'Should display the exception message' {
            ...
            Get-DokuPageInfo -FullName 'rootns:ns:pagename' -ErrorAction SilentlyContinue -ErrorVariable DokuErrorVariable
        ...
        Mock Invoke-DokuApiCall -ModuleName PSDokuWiki {
            return (
                [PSCustomObject]@{
                    ...
                    XMLPayloadResponse = '<?xml version="1.0"?><methodResponse><value><struct><member><name>FullName</name><value><string>rootns:ns:pagename</string></value></member><member><name>LastModified</name><value><string>11-11-2019</string></value></member><member><name>Author</name><value><string>User1</string></value></member><member><name>VersionTimestamp</name><value><int>11112019</int></value></member></struct></value></methodResponse>'
                }
            )
        }
        $ResponseObject = Get-DokuPageInfo -FullName 'rootns:ns:pagename'
    ...
    Context 'When information for two pages is returned' {
        Mock Invoke-DokuApiCall -ModuleName PSDokuWiki {
            return (
                [PSCustomObject]@{
                    CompletedSuccessfully = $true
                    XMLPayloadResponse = '<?xml version="1.0"?><methodResponse><value><struct><member><name>FullName</name><value><string>rootns2:ns2:pagename2</string></value></member><member><name>LastModified</name><value><string>11-11-2019</string></value></member><member><name>Author</name><value><string>User1</string></value></member><member><name>VersionTimestamp</name><value><int>11112019</int></value></member></struct></value></methodResponse>'
                }
            )
        }
        $ResponseObject = (Get-DokuPageInfo -FullName 'rootns:ns:pagename','rootns2:ns2:pagename2')[1]
