Describe 'Get-DokuAttachmentList' {
    ...
    Context 'When an attachment is returned' {
        Mock Invoke-DokuApiCall -ModuleName PSDokuWiki {
            return (
                [PSCustomObject]@{
                    ...
                    XMLPayloadResponse = '<?xml version="1.0"?><methodResponse><value><struct><member><name>FullName</name><value><string>rootns:ns:attachment.txt</string></value></member><member><name>Name</name><value><string>attachment.txt</string></value></member><member><name>Size</name><value><int>2048</int></value></member><member><name>VersionTimestamp</name><value><int>0102019</int></value></member><member><name>IsWritable</name><value><int>1</int></value></member><member><name>IsImage</name><value><int>1</int></value></member><member><name>Acl</name><value><int>255</int></value></member><member><name>LastModified</name><value><string>01-01-2019</string></value></member></struct></value></methodResponse>'
                }
            )
        }
        ...
        It 'Should return an object with the correct value for VersionTimestamp' {
            $ResponseObject.VersionTimestamp | Should -Be 101019
        }
